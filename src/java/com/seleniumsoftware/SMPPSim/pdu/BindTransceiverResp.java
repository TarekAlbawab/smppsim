 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/pdu/BindTransceiverResp.java,v 1.4 2011/01/31 08:00:23 martin Exp $
 ****************************************************************************/
...
public class BindTransceiverResp
    ...
    public BindTransceiverResp(
        BindTransceiver requestMsg,
        String sysid) {
        // message header fields except message length
        setCmd_id(PduConstants.BIND_TRANSCEIVER_RESP);
