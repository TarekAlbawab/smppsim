 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/pdu/EnquireLinkResp.java,v 1.4 2011/01/31 08:00:23 martin Exp $
 ****************************************************************************/
...
public class EnquireLinkResp extends Response implements Marshaller {
    ...
    public EnquireLinkResp(EnquireLink requestMsg) {
        // message header fields except message length
        setCmd_id(PduConstants.ENQUIRE_LINK_RESP);
