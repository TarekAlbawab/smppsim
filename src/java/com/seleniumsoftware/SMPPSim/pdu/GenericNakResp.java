 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/pdu/GenericNakResp.java,v 1.4 2011/01/31 08:00:23 martin Exp $
 ****************************************************************************/

package com.seleniumsoftware.SMPPSim.pdu;
import com.seleniumsoftware.SMPPSim.pdu.util.PduUtilities;

public class GenericNakResp extends Response implements Marshaller {

	public GenericNakResp(Pdu requestMsg) {
		// message header fields except message length
		setCmd_id(PduConstants.GENERIC_NAK);
